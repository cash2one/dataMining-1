...
--
-- Host: localhost    Database: topdata
-- ------------------------------------------------------
...
--
-- Dumping routines for database 'topdata'
--
/*!50003 DROP PROCEDURE IF EXISTS `sp_top_item_trade` */;
...
/*!50003 SET sql_mode              = '' */ ;
DELIMITER ;;
/*!50003 CREATE*/ /*!50020 DEFINER=`ibbd`@`%`*/ /*!50003 PROCEDURE `sp_top_item_trade`(inDateOf DATE)
...
-- Dump completed on 2013-01-05 18:19:40
